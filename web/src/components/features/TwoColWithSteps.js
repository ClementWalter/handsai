...
export default ({
  ...
  const defaultSteps = [
    {
      heading: "Shoot",
      description: "Use the camera to take pictures of your products"
    },
    {
      heading: "Evaluate",
    ...
    {
      heading: "Deploy",
      description: "The model is ready to be used on every support (web app, mobile), with or without internet connection"
    }
  ];
